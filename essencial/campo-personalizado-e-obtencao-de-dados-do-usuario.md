...
Os campos personalizados na Simplesdesk atuam como variáveis ​​para armazenar as informações do usuário, como e-mail, número de telefone, preferência e muito mais, com base em suas necessidades e no processo de construção do bot.
...
Espero que este artigo ajude você a entender mais sobre o recurso de campo personalizado na plataforma Simplesdesk.
...
&#xNAN;**\{{user\_state\}}**\
&#xNAN;**\{{user\_city\}}**\
&#xNAN;**\{{inbox\_link\}}:** link da conversa na Simplesdesk.\
&#xNAN;**\{{gender\}}**\
...
&#xNAN;**\{{user\_id\}}** : O ID do usuário de contato na Simplesdesk. Use este ID na API.\
